# MODELS_LEDGER — 전 트랙 모델 원장 (2026-08-29 기준)
...
| lowvol | sm_a | 초소형 유동성 프리미엄 — OOS 39/40, 판정 보류 | 20260627 | ~9월 초 | PREREGISTER_lowvol.md |
| lowvol | mom_a / mom_b | 모멘텀 대조(표시 별도) / mom_a+눌림목. mom_a 판정 완료 → '노이즈' | 20260627 / 0717 | 판정 완료 / 9월 중 | PREREGISTER_mom_b.md |
| lowvol | *lv_e* | *(초안·미등록)* lv_b + to20(저회전) — **sm_a 판정 후 등록**(8/29 결정), 등록 시 분모 10→11 | **미정** | 등록 + 40거래일 | PREREGISTER_lv_e.md |
